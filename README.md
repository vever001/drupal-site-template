...
```bash
docker run --rm -ti -v $PWD:/var/www/html -w /var/www/html fpfis/httpd-php-dev:7.1 composer create-project vever001/drupal-site-template --stability=dev <dg-name>-<project-id>-reference
```
